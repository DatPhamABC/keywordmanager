...
def query_negative_id(campaign_id, ad_group_id, keyword_id):
    ...
    # 'SELECT id FROM keywords.negative WHERE keyword_id = :keyword_id '
    #                                'AND (campaign_id = :campaign_id OR ad_group_id = :ad_group_id)',
    #                                {'keyword_id': keyword_id, 'campaign_id': campaign_id,
